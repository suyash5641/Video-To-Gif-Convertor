...
const DummyTimeline = () => {
  ...
  return (
    <div className="flex flex-row items-center bg-background fixed bottom-[40px] h-[110px]  md:relative md:bottom-auto w-full  md:h-[150px] bg-gradient-to-b from-transparent to-gray-900/10 backdrop-blur-sm border-t border-gray-200/10">
